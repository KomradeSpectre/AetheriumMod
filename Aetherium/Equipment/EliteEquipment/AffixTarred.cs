...
{
    public class AffixTarred : EliteEquipmentBase<AffixTarred>
    {
        public override string EliteEquipmentName => "Symbol of Viscocity";

        public override string EliteAffixToken => "AFFIX_TARRED";

        public override string EliteEquipmentPickupDesc => "Become an aspect of tar.";

        public override string EliteEquipmentFullDescription => "";

        public override string EliteEquipmentLore => "";

        public override string EliteModifier => "Tarred";
