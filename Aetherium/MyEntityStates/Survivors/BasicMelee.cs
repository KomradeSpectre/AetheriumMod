...
namespace Aetherium.MyEntityStates.Survivors
{
    public class BasicMelee : BaseSkillState
    {
        ...
        protected string playbackAnimationRateParamString = "Slash.playbackRate";
        ...
        public override void OnEnter()
        {
            ...
            this.earlyExitTime = this.baseEarlyExitTime * duration;
            this.hasFired = false;
        ...
        {
            base.PlayCrossfade("Gesture, Override", "Slash" + (1 + swingIndex), playbackAnimationRateParamString, this.duration, 0.05f);
        }
